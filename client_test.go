...
func TestModemGetNetworkTimePermissionDenied(t *testing.T) {
	m := &Modem{
		c: &Client{call: func(_ context.Context, _ string, _ dbus.ObjectPath, _ ...interface{}) (dbus.Variant, error) {
			// This is a privileged operation and D-Bus doesn't allow the caller
			// to perform it.
			return dbus.Variant{}, dbus.Error{Name: unauthorizedError}
		}},
	}
...
func TestModemGetNetworkTimeOK(t *testing.T) {
	m := &Modem{
		c: &Client{call: func(_ context.Context, method string, op dbus.ObjectPath, args ...interface{}) (dbus.Variant, error) {
			...
			return dbus.MakeVariant("2020-07-15T16:31:02-04:00"), nil
		}},
	}
