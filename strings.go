// Code generated by "stringer -type=BearerIPMethod,PortType,PowerState,State -output strings.go"; DO NOT EDIT.
...
func _() {
	...
	var x [1]struct{}
	_ = x[BearerIPMethodUnknown-0]
	_ = x[BearerIPMethodPPP-1]
	_ = x[BearerIPMethodStatic-2]
	_ = x[BearerIPMethodDHCP-3]
}

const _BearerIPMethod_name = "BearerIPMethodUnknownBearerIPMethodPPPBearerIPMethodStaticBearerIPMethodDHCP"

var _BearerIPMethod_index = [...]uint8{0, 21, 38, 58, 76}

func (i BearerIPMethod) String() string {
	if i < 0 || i >= BearerIPMethod(len(_BearerIPMethod_index)-1) {
		return "BearerIPMethod(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _BearerIPMethod_name[_BearerIPMethod_index[i]:_BearerIPMethod_index[i+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
